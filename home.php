...
<?php
//select ข้อมูลเมนูอาหารทั้งหมดในร้าน 8 รายการ
$sql = "SELECT * FROM menus LIMIT 8";
        ...
        <section class="slider_section ">
                ...
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        <div class="detail-box">
                            <h1>
                                ร้านอาหารยอดนิยม จังหวัดนครสวรรค์
                            </h1>
                            <p>
                                ค้นหาร้านอาหารภายในจังหวัดนครสวรรค์
                            </p>
                        </div>
            ...
            <div class="slider_container">
                <?php foreach ($menus_query as $menu) { ?>
                    <div class="item">
                        <div class="img-box">
                            <img src="images/menus/<?= $menu['mn_image'] ?>" alt="<?= $menu['mn_name'] ?>" />
                        </div>
                    </div>
                <?php } ?>
            </div>
