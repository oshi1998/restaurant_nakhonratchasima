...
if (isset($_POST['name'])) {
    ...
    //insert
    $sql = "INSERT INTO restaurants (res_name,res_short_desc,res_full_desc,res_url,res_office_time,res_image,res_map,res_status,ft_id,user_id)
    VALUES ('$name','$short_desc','$full_desc','$url','$office_time','$image','$map','$status','$ft_id','$user_id')";
